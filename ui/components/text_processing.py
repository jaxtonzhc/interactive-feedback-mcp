...
class TextProcessor:
    ...
    def convert_text_to_html(text: str, line_height: float = 1.3) -> str:
        ...
        text_color = '#ccc' if GlassmorphismStyles.is_dark() else '#1a1a1a'
    ...
    def convert_markdown_to_html(markdown_text: str, line_height: float = 1.3) -> str:
        ...
        try:
            ...
            is_dark = GlassmorphismStyles.is_dark()
            text_color = '#ccc' if is_dark else '#1a1a1a'
            h1_color = '#FF9800' if is_dark else '#E65100'
            h2_color = '#2196F3' if is_dark else '#1565C0'
            h3_color = '#4CAF50' if is_dark else '#2E7D32'
            strong_color = '#FFD54F' if is_dark else '#E65100'
            em_color = '#81C784' if is_dark else '#2E7D32'
            code_bg = 'rgba(255,255,255,0.1)' if is_dark else 'rgba(0,0,0,0.06)'
            pre_bg = 'rgba(255,255,255,0.05)' if is_dark else 'rgba(0,0,0,0.04)'
            table_border = '#444' if is_dark else '#ccc'
            th_bg = 'rgba(255,255,255,0.1)' if is_dark else 'rgba(0,0,0,0.04)'
            ...
            <style>
                ...
                h1 {{ color: {h1_color}; margin: 12px 0 8px 0; font-size: 1.3em; }}
                h2 {{ color: {h2_color}; margin: 10px 0 6px 0; font-size: 1.2em; }}
                h3 {{ color: {h3_color}; margin: 10px 0 6px 0; font-size: 1.1em; }}
                ul, ol {{
                    margin: 6px 0;
                    padding-left: 20px;
                }}
